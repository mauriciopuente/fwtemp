...
statement2 = '''update admin.user_clone_group set comment = 'OLD DUPLICATE' where id = (select ucg_id from admin.user a where unique_machine_id = '%s' and last_connected = %d)'''
